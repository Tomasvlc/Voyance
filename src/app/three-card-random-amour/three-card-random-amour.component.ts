...
@Component({
  selector: 'app-three-card-random-amour',
  templateUrl: './three-card-random-amour.component.html',
  styleUrls: ['./three-card-random-amour.component.css']
})
export class ThreeCardRandomAmourComponent implements OnInit {
